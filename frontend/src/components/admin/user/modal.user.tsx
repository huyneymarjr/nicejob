...
const ModalUser = (props: IProps) => {
    ...
    const [rolesTeamp, setRolesTeamp] = useState<ICompanySelect | null>(null)
    ...
    const submitUser = async (valuesForm: any) => {
        ...
        if (dataInit?._id) {
            ...
            if (res.data) {
                message.success("Thêm mới người dùng mới thành công")
                handleReset()
                reloadTable()
            } else {
                notification.error({
                            ...
                            rules={[
                                {
                                    required: true,
                                    message:
                                        "Vui lòng không bỏ trống tên hiển thị",
                                },
                            ]}
                    ...
                    <Col lg={6} md={6} sm={24} xs={24}>
                        <ProFormDigit
                            ...
                            rules={[
                                {
                                    required: true,
                                    message: "Vui lòng không bỏ trống tuổi",
                                },
                            ]}
                        ...
                        >
                            <DebounceSelect
                                ...
                                onChange={(newValue: any) => {
                                    ...
                                    if (newValue) setRolesTeamp(newValue)
                                }}
                                style={{ width: "100%" }}
                            />
                        </ProForm.Item>
                    ...
                    <Col lg={12} md={12} sm={24} xs={24}>
                        <ProFormText
                            ...
                            rules={[
                                {
                                    required: true,
                                    message: "Vui lòng không bỏ trống địa chỉ",
                                },
                            ]}
